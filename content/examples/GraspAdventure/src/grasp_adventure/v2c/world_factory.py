...
class WorldFactory:
    ...
    def create(
        ...
        """
        return World(
            locations=(WorldFactory._create_locations(location_descriptions)),
    ...
    def _create_locations(
        ...
        >>> WorldFactory._create_locations(
        ...
        """
        locations = WorldFactory._create_locations_without_connections(
